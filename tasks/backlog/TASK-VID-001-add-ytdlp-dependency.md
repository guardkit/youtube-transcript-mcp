...
autobuild_state:
  ...
  base_branch: main
  started_at: '2026-03-09T14:28:24.434153'
  last_updated: '2026-03-09T14:31:41.140224'
  turns:
  - turn: 1
    decision: approve
    feedback: null
    timestamp: '2026-03-09T14:28:24.434153'
    player_summary: '[RECOVERED via player_report] Original error: Cancelled: Cancelled
      via cancel scope 1195ef290 by <Task pending name=''Task-101'' coro=<<async_generator_athrow
      without __name__>()>>'
    player_success: true
    coach_success: true
---
